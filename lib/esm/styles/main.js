...
export var ContentWrapper = styled.div(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n\t&:last-of-type {\n\t\tmargin-top: 5px;\n\t}\n"], ["\n\t&:last-of-type {\n\t\tmargin-top: 5px;\n\t}\n"])));
export var Icon = styled.i(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n\tfont-style: normal;\n\tmargin-right: 3px;\n\ttransform: rotate(", ");\n\n\t@media (prefers-reduced-motion: no-preference) {\n\t\ttransition: transform 0.2s ease-in-out;\n\t}\n"], ["\n\tfont-style: normal;\n\tmargin-right: 3px;\n\ttransform: rotate(", ");\n\n\t@media (prefers-reduced-motion: no-preference) {\n\t\ttransition: transform 0.2s ease-in-out;\n\t}\n"])), function (props) { return (props.isShowing ? '90deg' : '0deg'); });
export var EventTitle = styled.h3(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n\talign-content: center;\n\talign-items: center;\n\tcolor: ", ";\n\tcursor: ", ";\n\tdisplay: flex;\n\tfont-size: 14px;\n\tfont-weight: bold;\n\tmargin: 0;\n\twidth: max-content;\n"], ["\n\talign-content: center;\n\talign-items: center;\n\tcolor: ", ";\n\tcursor: ", ";\n\tdisplay: flex;\n\tfont-size: 14px;\n\tfont-weight: bold;\n\tmargin: 0;\n\twidth: max-content;\n"])), function (props) { return props.theme.subtitleColor; }, function (props) { return (props.collapse ? 'pointer' : 'default'); });
export var DescriptionWrapper = styled.div(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n\tpadding-left: 10px;\n"], ["\n\tpadding-left: 10px;\n"])));
export var Description = styled.p(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n\tcolor: ", ";\n\tfont-size: 14px;\n\tmargin: 3px 0 0 0;\n"], ["\n\tcolor: ", ";\n\tfont-size: 14px;\n\tmargin: 3px 0 0 0;\n"])), function (props) { return props.theme.textColor; });
