...
export var Subtitle = styled.h3(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n\talign-content: center;\n\talign-items: center;\n\tcolor: ", ";\n\tcursor: ", ";\n\tdisplay: flex;\n\tfont-size: 14px;\n\tfont-weight: bold;\n\tmargin: 0;\n\twidth: max-content;\n"], ["\n\talign-content: center;\n\talign-items: center;\n\tcolor: ", ";\n\tcursor: ", ";\n\tdisplay: flex;\n\tfont-size: 14px;\n\tfont-weight: bold;\n\tmargin: 0;\n\twidth: max-content;\n"])), function (props) { return props.theme.subtitleColor; }, function (props) { return (props.collapse ? 'pointer' : 'default'); });
export var DescriptionText = styled.li(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n\tcolor: ", ";\n\tfont-size: 14px;\n\tmargin-top: 3px;\n"], ["\n\tcolor: ", ";\n\tfont-size: 14px;\n\tmargin-top: 3px;\n"])), function (props) { return props.theme.textColor; });
