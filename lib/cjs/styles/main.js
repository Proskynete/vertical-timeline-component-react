...
exports.TextErrorMessage = exports.Description = exports.DescriptionWrapper = exports.EventTitle = exports.Icon = exports.BodyInner = exports.Title = exports.BodyWrapper = exports.YearSpan = exports.YearWrapper = exports.ContainerWrapper = exports.TimelineWrapperInner = exports.TimelineWrapper = void 0;
...
exports.BodyInner = styled_components_1.default.div(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n\tfont-size: 1rem;\n\tlist-style-type: none;\n\tmargin: 5px 0 16px;\n\tmax-width: 100%;\n\tpadding: 0;\n\n\t&:last-child {\n\t\tmargin-bottom: 0;\n\t}\n"], ["\n\tfont-size: 1rem;\n\tlist-style-type: none;\n\tmargin: 5px 0 16px;\n\tmax-width: 100%;\n\tpadding: 0;\n\n\t&:last-child {\n\t\tmargin-bottom: 0;\n\t}\n"])));
exports.Icon = styled_components_1.default.i(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n\tfont-style: normal;\n\tmargin-right: 3px;\n\ttransform: rotate(", ");\n\n\t@media (prefers-reduced-motion: no-preference) {\n\t\ttransition: transform 0.2s ease-in-out;\n\t}\n"], ["\n\tfont-style: normal;\n\tmargin-right: 3px;\n\ttransform: rotate(", ");\n\n\t@media (prefers-reduced-motion: no-preference) {\n\t\ttransition: transform 0.2s ease-in-out;\n\t}\n"])), function (props) { return (props.isShowing ? '90deg' : '0deg'); });
exports.EventTitle = styled_components_1.default.h3(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n\talign-content: center;\n\talign-items: flex-start;\n\tcolor: ", ";\n\tcursor: ", ";\n\tdisplay: flex;\n\tfont-size: 0.875rem;\n\tfont-weight: bold;\n\tmargin: 0;\n\tmax-width: 100%;\n\n\t&:not(:first-child) {\n\t\tmargin-top: 8px;\n\t}\n"], ["\n\talign-content: center;\n\talign-items: flex-start;\n\tcolor: ", ";\n\tcursor: ", ";\n\tdisplay: flex;\n\tfont-size: 0.875rem;\n\tfont-weight: bold;\n\tmargin: 0;\n\tmax-width: 100%;\n\n\t&:not(:first-child) {\n\t\tmargin-top: 8px;\n\t}\n"])), function (props) { return props.theme.subtitleColor; }, function (props) { return (props.collapse ? 'pointer' : 'default'); });
exports.DescriptionWrapper = styled_components_1.default.div(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n\tpadding-left: 10px;\n"], ["\n\tpadding-left: 10px;\n"])));
...
exports.TextErrorMessage = styled_components_1.default.p(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n\tcolor: ", ";\n\tfont-size: 0.875rem;\n\ttext-align: center;\n\twidth: 100%;\n\n\tcode {\n\t\tbackground-color: ", ";\n\t\tcolor: ", ";\n\t\tdisplay: inline-block;\n\t\tfont-size: 0.875rem;\n\t\tpadding: 3px 5px;\n\t\tborder-radius: 5px;\n\t}\n"], ["\n\tcolor: ", ";\n\tfont-size: 0.875rem;\n\ttext-align: center;\n\twidth: 100%;\n\n\tcode {\n\t\tbackground-color: ", ";\n\t\tcolor: ", ";\n\t\tdisplay: inline-block;\n\t\tfont-size: 0.875rem;\n\t\tpadding: 3px 5px;\n\t\tborder-radius: 5px;\n\t}\n"])), function (props) { return props.theme.textColor; }, function (props) { return props.theme.dotColor; }, function (props) { return props.theme.subtitleColor; });
