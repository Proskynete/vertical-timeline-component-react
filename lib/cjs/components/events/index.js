...
var Events = function (_a) {
    var _b;
    var title = _a.title, subtitle = _a.subtitle, startDate = _a.startDate, endDate = _a.endDate, active = _a.active, withoutDay = _a.withoutDay, children = _a.children;
    ...
    return (react_1.default.createElement(main_1.ContainerWrapper, null,
        ...
        react_1.default.createElement(main_1.BodyWrapper, null,
            ...
            subtitle && react_1.default.createElement(main_1.Subtitle, null, subtitle),
