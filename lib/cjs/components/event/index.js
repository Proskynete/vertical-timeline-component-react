...
var Event = function (_a) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        show && (react_1.default.createElement(main_1.DescriptionWrapper, null, description.map(function (text, i) {
            var _a;
            return (react_1.default.createElement(main_1.Description, { key: i, style: (_a = config.customStyles) === null || _a === void 0 ? void 0 : _a.description, symbol: config.descriptionSymbol }, text));
        })))));
};
exports.Event = Event;
