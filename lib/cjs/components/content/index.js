...
var Content = function (_a) {
    ...
    return (react_1.default.createElement(main_1.ContentWrapper, null,
        react_1.default.createElement(main_1.Subtitle, { collapse: collapse || config.collapse, onClick: function () {
                if (collapse || config.collapse)
                    handleSetShow();
            } },
            (collapse || config.collapse) && (react_1.default.createElement("i", { style: {
                    marginRight: '3px',
                    fontStyle: 'normal',
            ...
            title),
        show && (react_1.default.createElement("div", { style: { paddingLeft: '10px' } }, description.map(function (text, index) { return (react_1.default.createElement(main_1.DescriptionText, { key: index }, text)); })))));
};
